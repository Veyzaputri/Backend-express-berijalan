...
export const SLogin = async (usernameOrEmail, password) => {
...
export const SCreateAdmin = async (username, password, email, name) => {
...
export const SUpdateAdmin = async (id, data) => {
    try {
        if (data.password) {
...
export const SDeleteAdmin = async (id) => {
    try {
